...
export class CookieStore extends EventTarget {
	 ...
	 * @param {CookieStoreOptions} [options] An object providing values to initialize this instance.
	 */
	constructor(options = {}) {
		super();
	...
	*[Symbol.iterator]() {
	 ...
	 * @param {string} key The cookie name.
	 * @param {unknown} value The cookie value.
	 * @param {import("./cookie_options.js").CookieOptionsParams} [options] The cookie options.
	 * @returns {this} This instance.
	 */
 ...
 * @property {import("./cookie_options.js").CookieOptionsParams} [defaults] The default cookie options.
